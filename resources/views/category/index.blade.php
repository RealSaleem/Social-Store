...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-grid4"></i> <span class="font-weight-semibold">{{trans('site.categories')}}</h4>
        ...
        <div class="col-xl-12">
            <div class="actions mb-2">
                <div class="text-right">
                    <a class="btn btn-primary" href="{{route('category.create')}}"><i class="icon-grid4"></i> &nbsp; {{trans('site.add_category')}}</a>
                </div>
            </div>
            <div class="card">
