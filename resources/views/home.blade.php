        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">{{ $users->count() }} {{trans('site.app_users')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_users')}}</p>
        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">{{ $ads->count() }} {{trans('site.ads')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_ads')}}</p>
        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">{{ $reportedposts->count() }} {{trans('site.reported_posts')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_reported_posts')}}</p>
        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">{{ $reportedusers->count() }} {{trans('site.reported_users')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_reported_users')}}</p>
        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">0 {{trans('site.stories_database')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_stories')}}</p>
        ...
        <div class="col-xl-4">
            <div class="box-bordr card text-center">
                <div class="card-body">
                    ...
                    <p class="mb-2">{{trans('site.you_have')}} <strong class="txt-sz">0 {{trans('site.bids_database')}}</strong> {{trans('site.in_database')}}</br>{{trans('site.click_button')}} {{trans('site.view_all_bids')}}</p>
